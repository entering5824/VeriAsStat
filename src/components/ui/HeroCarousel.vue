...
const slides = [
    {
    image: '/images/gi/icons/gi.jpeg',
    icon: '/images/gi/icons/gi_icon.jpeg',
  ...
  {
    image: '/images/hsr/icons/hsr.jpg',
    icon: '/images/hsr/icons/hsr_icon.png',
  ...
  {
    image: '/images/zzz/icons/zzz.jpg',
    icon: '/images/zzz/icons/zzz_icon.png',
